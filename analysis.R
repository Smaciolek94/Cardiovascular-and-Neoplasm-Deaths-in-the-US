#import section
cmonth <- read.csv("E:\\School\\565\\Final Project\\Circulatory by Month.csv",header=T)
nmonth <- read.csv("E:\\School\\565\\Final Project\\Neoplasm by Month.csv",header=T)
cyear <- read.csv("E:\\School\\565\\Final Project\\Circulatory by Year.csv",header=T)
nyear <- read.csv("E:\\School\\565\\Final Project\\Neoplasm by Year.csv",header=T)
...
shapiro.test(cvmodel$residuals)
...
lines(np,type="l",col="red")
lines(cvout,type="l",col="black")
lines(cvupper,type="l",col="blue")
lines(cvlower,type="l",col="blue")
lines(npout,type="l",col="black")
lines(npupper,type="l",col="red")
lines(nplower,type="l",col="red")
